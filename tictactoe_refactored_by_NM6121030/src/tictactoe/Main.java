...
public class Main {
    ...
    //config setting
    public static final int BOARD_SIZE = 7; // 定義棋盤大小的常數
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while(command.equals("0"))
        {
            ...
            command = checkCommand(command, input);	// check user's input
                ...
                while(second_command.equals("1")||second_command.equals("R"))
                {
                    ...
                    while(winning==0) {
                        ...
                        while (valid_move) {
                            ...
                            valid_move = moveX(mat, choice);
                            winning = check_if_won(mat);
...
//____________________________________________________________________________________________
    ...
    /**
     * This function check the user's input
     */
    public static String checkCommand(String command, Scanner input) {
        while (!(command.equals("0") || command.equals("1") || command.equals("2") || command.equals("3") || command.equals("4") || command.equalsIgnoreCase("Exit"))) {
            cls();
            System.out.println(ANSI_RED + "Wrong command!!! Please enter '0' or 'Exit'." + ANSI_RESET);
    ...
    public static boolean moveX(String[][] mat,String a)
    {
        for(int i=0;i<4;i++)
        {
            for(int j=0;j<4;j++)
            {
                ...
                {
                    return true;	// "cheat" move is valid
                }
            }
        }
    ...
    public static boolean moveO(String[][] mat,String a)
    {
        for(int i=0;i<4;i++)
        {
            for(int j=0;j<4;j++)
    ...
    public static int check_if_won(String[][] mat)
    {
        for(int i=0;i<4;i++)
        {
            for(int j=0;j<4;j++)
